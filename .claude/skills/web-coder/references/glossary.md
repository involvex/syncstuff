...
- [Alpha (_alpha channel_)](https://developer.mozilla.org/en-US/docs/Glossary/Alpha)
...
- [Baseline](https://developer.mozilla.org/en-US/docs/Glossary/Baseline)
  - [Baseline (_compatibility_)](https://developer.mozilla.org/en-US/docs/Glossary/Baseline/Compatibility)
  - [Baseline (_typography_)](https://developer.mozilla.org/en-US/docs/Glossary/Baseline/Typography)
...
- [Blink](https://developer.mozilla.org/en-US/docs/Glossary/Blink)
  - [blink element (_\<blink\> tag_)](https://developer.mozilla.org/en-US/docs/Glossary/blink_element)
- [Block](https://developer.mozilla.org/en-US/docs/Glossary/Block)
  - [Block (_CSS_)](https://developer.mozilla.org/en-US/docs/Glossary/Block/CSS)
  - [Block (_scripting_)](https://developer.mozilla.org/en-US/docs/Glossary/Block/Scripting)
...
- [Boolean](https://developer.mozilla.org/en-US/docs/Glossary/Boolean)
  - [Boolean (_JavaScript_)](https://developer.mozilla.org/en-US/docs/Glossary/Boolean/JavaScript)
  - [Boolean attribute (_ARIA_)](https://developer.mozilla.org/en-US/docs/Glossary/Boolean/ARIA)
  - [Boolean attribute (_HTML_)](https://developer.mozilla.org/en-US/docs/Glossary/Boolean/HTML)
...
- [Client-side rendering (_CSR_)](<https://developer.mozilla.org/en-US/docs/Glossary/Client-side_rendering_(CSR)>)
...
- [Cross-site request forgery (_CSRF_)](https://developer.mozilla.org/en-US/docs/Glossary/CSRF)
- [Cross-site scripting (_XSS_)](https://developer.mozilla.org/en-US/docs/Glossary/Cross-site_scripting)
...
- [CSS Object Model (_CSSOM_)](<https://developer.mozilla.org/en-US/docs/Glossary/CSS_Object_Model_(CSSOM)>)
- [CSS pixel](https://developer.mozilla.org/en-US/docs/Glossary/CSS_pixel)
- [CSS preprocessor](https://developer.mozilla.org/en-US/docs/Glossary/CSS_preprocessor)
- [Cumulative Layout Shift (_CLS_)](https://developer.mozilla.org/en-US/docs/Glossary/CLS)
...
- [Denial of Service (_DoS_)](https://developer.mozilla.org/en-US/docs/Glossary/Denial_of_Service)
- [Deno](https://developer.mozilla.org/en-US/docs/Glossary/Deno)
- [Descriptor (_CSS_)](<https://developer.mozilla.org/en-US/docs/Glossary/Descriptor_(CSS)>)
...
- [Distributed Denial of Service (_DDoS_)](https://developer.mozilla.org/en-US/docs/Glossary/Distributed_Denial_of_Service)
...
- [DOM (_Document Object Model_)](https://developer.mozilla.org/en-US/docs/Glossary/DOM)
...
- [DSL](https://developer.mozilla.org/en-US/docs/Glossary/DSL)
  - [DSL (_Digital Subscriber Line_)](https://developer.mozilla.org/en-US/docs/Glossary/DSL/Digital_Subscriber_Line)
  - [DSL (_Domain-Specific Language_)](https://developer.mozilla.org/en-US/docs/Glossary/DSL/Domain-Specific_Language)
- [DTLS (_Datagram Transport Layer Security_)](https://developer.mozilla.org/en-US/docs/Glossary/DTLS)
- [DTMF (_Dual-Tone Multi-Frequency signaling_)](https://developer.mozilla.org/en-US/docs/Glossary/DTMF)
...
- [First Contentful Paint (_FCP_)](<https://developer.mozilla.org/en-US/docs/Glossary/First_Contentful_Paint_(FCP)>)
...
- [First Meaningful Paint (_FMP_)](https://developer.mozilla.org/en-US/docs/Glossary/First_meaningful_paint)
- [First Paint (_FP_)](https://developer.mozilla.org/en-US/docs/Glossary/First_paint)
...
- [Frame rate (_FPS_)](https://developer.mozilla.org/en-US/docs/Glossary/FPS)
...
- [Identity provider (_IdP_)](https://developer.mozilla.org/en-US/docs/Glossary/Identity_provider)
...
- [Interaction to Next Paint (_INP_)](https://developer.mozilla.org/en-US/docs/Glossary/interaction_to_next_paint)
- [Internationalization (_i18n_)](https://developer.mozilla.org/en-US/docs/Glossary/Internationalization)
...
- [Just-In-Time Compilation (_JIT_)](https://developer.mozilla.org/en-US/docs/Glossary/Just-in-time_compilation)
...
- [Largest Contentful Paint (_LCP_)](https://developer.mozilla.org/en-US/docs/Glossary/Largest_contentful_paint)
...
- [LTR (_Left To Right_)](https://developer.mozilla.org/en-US/docs/Glossary/LTR)
...
- [Media](https://developer.mozilla.org/en-US/docs/Glossary/Media)
  - [Media (_Audio-visual presentation_)](https://developer.mozilla.org/en-US/docs/Glossary/Media/Audio-visual_presentation)
  - [Media (_CSS_)](https://developer.mozilla.org/en-US/docs/Glossary/Media/CSS)
...
- [Node](https://developer.mozilla.org/en-US/docs/Glossary/Node)
  - [Node (_DOM_)](https://developer.mozilla.org/en-US/docs/Glossary/Node/DOM)
  - [Node (_networking_)](https://developer.mozilla.org/en-US/docs/Glossary/Node/Networking)
...
- [Progressive web applications (_PWAs_)](https://developer.mozilla.org/en-US/docs/Glossary/Progressive_web_apps)
...
- [Property](https://developer.mozilla.org/en-US/docs/Glossary/Property)
  - [Property (_CSS_)](https://developer.mozilla.org/en-US/docs/Glossary/Property/CSS)
  - [Property (_JavaScript_)](https://developer.mozilla.org/en-US/docs/Glossary/Property/JavaScript)
...
- [Real User Monitoring (_RUM_)](https://developer.mozilla.org/en-US/docs/Glossary/Real_User_Monitoring)
...
- [Responsive Web Design (_RWD_)](https://developer.mozilla.org/en-US/docs/Glossary/Responsive_Web_Design)
...
- [Round Trip Time (_RTT_)](https://developer.mozilla.org/en-US/docs/Glossary/Round_Trip_Time)
...
- [RTCP (_RTP Control Protocol_)](https://developer.mozilla.org/en-US/docs/Glossary/RTCP)
- [RTF](https://developer.mozilla.org/en-US/docs/Glossary/RTF)
- [RTL (_Right to Left_)](https://developer.mozilla.org/en-US/docs/Glossary/RTL)
- [RTP (_Real-time Transport Protocol_) and SRTP (_Secure RTP_)](https://developer.mozilla.org/en-US/docs/Glossary/RTP)
...
- [Safe](https://developer.mozilla.org/en-US/docs/Glossary/Safe)
  - [Safe (_HTTP Methods_)](https://developer.mozilla.org/en-US/docs/Glossary/Safe/HTTP)
...
- [SDK (_Software Development Kit_)](https://developer.mozilla.org/en-US/docs/Glossary/SDK)
...
- [Secure Sockets Layer (_SSL_)](https://developer.mozilla.org/en-US/docs/Glossary/SSL)
- [Selector (_CSS_)](https://developer.mozilla.org/en-US/docs/Glossary/CSS_Selector)
...
- [Server-side rendering (_SSR_)](https://developer.mozilla.org/en-US/docs/Glossary/SSR)
...
- [Signature (_functions_)](<https://developer.mozilla.org/en-US/docs/Glossary/Signature_(functions)>)
- [Signature (_security_)](<https://developer.mozilla.org/en-US/docs/Glossary/Signature_(security)>)
...
- [SMPTE (_Society of Motion Picture and Television Engineers_)](https://developer.mozilla.org/en-US/docs/Glossary/SMPTE)
...
- [SPA (_Single-page application_)](https://developer.mozilla.org/en-US/docs/Glossary/SPA)
...
- [Static site generator (_SSG_)](https://developer.mozilla.org/en-US/docs/Glossary/SSG)
...
- [Time to First Byte (_TTFB_)](https://developer.mozilla.org/en-US/docs/Glossary/Time_to_first_byte)
- [Time to Interactive (_TTI_)](https://developer.mozilla.org/en-US/docs/Glossary/Time_to_interactive)
...
- [Transport Layer Security (_TLS_)](https://developer.mozilla.org/en-US/docs/Glossary/TLS)
...
- [UDP (_User Datagram Protocol_)](https://developer.mozilla.org/en-US/docs/Glossary/UDP)
...
- [XMLHttpRequest (_XHR_)](<https://developer.mozilla.org/en-US/docs/Glossary/XMLHttpRequest_(XHR)>)
