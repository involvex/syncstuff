...
exports.Text = react_1.default.forwardRef(
...
exports.Paragraph = react_1.default.forwardRef(
  ({ className, style, ...props }, ref) => {
    const { style: layoutStyle, restProps } = (0, utils_1.extractLayoutProps)(
      props,
    );
...
exports.H1 = react_1.default.forwardRef(
  ({ className, style, ...props }, ref) => {
    const { style: layoutStyle, restProps } = (0, utils_1.extractLayoutProps)(
      props,
    );
...
exports.H2 = react_1.default.forwardRef(
  ({ className, style, ...props }, ref) => {
    const { style: layoutStyle, restProps } = (0, utils_1.extractLayoutProps)(
      props,
    );
...
exports.H3 = react_1.default.forwardRef(
  ({ className, style, ...props }, ref) => {
    const { style: layoutStyle, restProps } = (0, utils_1.extractLayoutProps)(
      props,
    );
...
exports.H4 = react_1.default.forwardRef(
  ({ className, style, ...props }, ref) => {
    const { style: layoutStyle, restProps } = (0, utils_1.extractLayoutProps)(
      props,
    );
...
exports.H5 = react_1.default.forwardRef(
  ({ className, style, ...props }, ref) => {
    const { style: layoutStyle, restProps } = (0, utils_1.extractLayoutProps)(
      props,
    );
...
exports.H6 = react_1.default.forwardRef(
  ({ className, style, ...props }, ref) => {
    const { style: layoutStyle, restProps } = (0, utils_1.extractLayoutProps)(
      props,
    );
    return (0, jsx_runtime_1.jsx)("h6", {
      ref: ref,
      className: (0, utils_1.cn)(
