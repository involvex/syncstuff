...
exports.Button = react_1.default.forwardRef(({ className, variant = "default", size = "default", style, onPress, onClick, icon, children, ...props }, ref) => {
    ...
    const variantStyles = {
        ...
        outline: "border border-primary bg-transparent text-primary hover:bg-primary hover:text-onPrimary",
    ...
    return ((0, jsx_runtime_1.jsxs)("button", { ref: ref, className: cn(baseStyles, variantStyles[variant], sizeStyles[size], className), style: { ...layoutStyle, ...style }, onClick: handleClick, ...restProps, children: [icon && (0, jsx_runtime_1.jsx)("span", { className: "mr-2", children: icon }), children] }));
});
