...
exports.Button = react_1.default.forwardRef(({ className, variant = "default", size = "default", style, onPress, onClick, icon, children, ...props }, ref) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("button", { className: cn(baseStyles, variantStyles[variant], sizeStyles[size], className), onClick: handleClick, ref: ref, style: { ...layoutStyle, ...style }, ...restProps, children: [icon && (0, jsx_runtime_1.jsx)("span", { className: "mr-2", children: icon }), children] }));
});
