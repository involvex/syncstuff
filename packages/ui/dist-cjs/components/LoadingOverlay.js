...
function LoadingOverlay({ message = "Loading...", }) {
    return ((0, jsx_runtime_1.jsx)("div", { className: _cn, children: (0, jsx_runtime_1.jsxs)(tamagui_1.YStack, { alignItems: "center", backgroundColor: "$background", borderRadius: "$4", elevation: "$4", padding: "$6", space: "$4", children: [(0, jsx_runtime_1.jsx)(tamagui_1.Spinner, { color: "$primary", size: "large" }), (0, jsx_runtime_1.jsx)("span", { className: _cn2, children: message })] }) }));
}
