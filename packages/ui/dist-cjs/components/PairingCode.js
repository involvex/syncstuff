...
function PairingCode({ code }) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: _cn, children: digits.map((digit, index) => ((0, jsx_runtime_1.jsx)(CodeDigit, { children: (0, jsx_runtime_1.jsx)("span", { className: _cn2, children: digit }) }, index))) }));
}
