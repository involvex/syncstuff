...
function TransferProgress({ fileName, progress, speed, remainingTime, }) {
    return ((0, jsx_runtime_1.jsxs)(tamagui_1.YStack, { backgroundColor: "$background", borderColor: "$borderColor", borderRadius: "$3", borderWidth: 1, padding: "$3", space: "$2", children: [(0, jsx_runtime_1.jsxs)("div", { className: _cn, children: [(0, jsx_runtime_1.jsx)("span", { className: _cn2, children: fileName }), (0, jsx_runtime_1.jsxs)("span", { className: _cn3, children: [progress, "%"] })] }), (0, jsx_runtime_1.jsx)(tamagui_1.Progress, { size: "$2", value: progress, children: (0, jsx_runtime_1.jsx)(tamagui_1.Progress.Indicator, { animation: "quick", backgroundColor: "$blue10" }) }), (0, jsx_runtime_1.jsxs)("div", { className: _cn4, children: [speed && (0, jsx_runtime_1.jsx)("span", { className: _cn5, children: speed }), remainingTime && (0, jsx_runtime_1.jsx)("span", { className: _cn6, children: remainingTime })] })] }));
}
