...
function Navigation({ isLoggedIn, onLogin, onSignup, onDashboard }) {
  return (0, jsx_runtime_1.jsxs)("div", {
    className:
      "flex flex-row h-16 items-center justify-between px-4 bg-background border-b border-slate-200 dark:border-slate-800 absolute top-0 left-0 right-0 z-50",
    children: [
      (0, jsx_runtime_1.jsx)(Layouts_1.XStack, {
