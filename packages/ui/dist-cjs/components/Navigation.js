...
function Navigation({ isLoggedIn, onLogin, onSignup, onDashboard, }) {
    return ((0, jsx_runtime_1.jsxs)("div", { className: _cn, children: [(0, jsx_runtime_1.jsx)(tamagui_1.XStack, { alignItems: "center", space: "$2", children: (0, jsx_runtime_1.jsx)("span", { className: _cn2, children: "Syncstuff" }) }), (0, jsx_runtime_1.jsxs)(tamagui_1.XStack, { alignItems: "center", space: "$4", children: [(0, jsx_runtime_1.jsxs)(tamagui_1.XStack, { "$sm": {
                            display: "none",
                        }, space: "$4", children: [(0, jsx_runtime_1.jsx)("span", { className: _cn3, children: "Features" }), (0, jsx_runtime_1.jsx)("span", { className: _cn4, children: "Pricing" }), (0, jsx_runtime_1.jsx)("span", { className: _cn5, children: "Docs" })] }), (0, jsx_runtime_1.jsx)(ThemeToggle_1.ThemeToggle, {}), isLoggedIn ? ((0, jsx_runtime_1.jsx)(tamagui_1.Button, { onPress: onDashboard, size: "$3", theme: "blue", children: "Dashboard" })) : ((0, jsx_runtime_1.jsxs)(tamagui_1.XStack, { space: "$2", children: [(0, jsx_runtime_1.jsx)(tamagui_1.Button, { onPress: onLogin, size: "$3", variant: "outlined", children: "Login" }), (0, jsx_runtime_1.jsx)(tamagui_1.Button, { onPress: onSignup, size: "$3", theme: "blue", children: "Sign Up" })] }))] })] }));
}
