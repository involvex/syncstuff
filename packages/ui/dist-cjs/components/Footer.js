...
function Footer() {
  return (0, jsx_runtime_1.jsxs)(Layouts_1.YStack, {
    className:
      "bg-background border-t border-slate-200 dark:border-slate-800 px-4 py-8 gap-4",
    children: [
        ...
        children: [
          (0, jsx_runtime_1.jsxs)(Typography_1.Text, {
            ...
            children: [
              ...
              " Involvex. All rights reserved.",
            ],
          }),
          (0, jsx_runtime_1.jsx)(Layouts_1.XStack, { className: "gap-4" }),
        ],
      }),
    ],
  });
