...
function Provider({ children, ...rest }) {
    ...
    return ((0, jsx_runtime_1.jsx)(ThemeContext.Provider, { value: {
            ...
            toggleTheme,
            setTheme,
        }, children: (0, jsx_runtime_1.jsx)(tamagui_1.TamaguiProvider, { config: tamagui_config_1.tamaguiConfig, defaultTheme: theme, ...rest, children: (0, jsx_runtime_1.jsx)(tamagui_1.Theme, { name: theme, children: children }) }) }));
}
