        ...
        <div className="mt-6">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            ...
            >
              ...
              <span className="text-sm leading-6 font-semibold">GitHub</span>
            </a>
            <a
              href="/auth/discord"
              className="flex w-full items-center justify-center gap-3 rounded-md bg-[#5865F2] px-3 py-1.5 text-sm leading-6 font-semibold text-white shadow-sm hover:bg-[#4752C4] focus-visible:ring-transparent"
            >
              <svg
                className="size-5"
                aria-hidden="true"
              ...
              <span className="text-sm leading-6 font-semibold">Discord</span>
            </a>
          </div>
        </div>
