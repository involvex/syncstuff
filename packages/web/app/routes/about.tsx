      ...
      <div className="relative isolate overflow-hidden py-24 sm:py-32">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-6xl dark:text-white">
              About SyncStuff
            </h2>
            ...
            <div className="flex flex-col">
              ...
              <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600 dark:text-gray-400">
                <p className="flex-auto">
                  To democratize cross-device productivity by providing a fast,
                  secure, and open-source platform for synchronization.
                </p>
              </dd>
            </div>
            <div className="flex flex-col">
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div className="mx-auto mt-20 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-4">
          <div className="text-center">
            <div className="mx-auto size-32 overflow-hidden rounded-full bg-gray-100 dark:bg-gray-800">
              <img
                src="https://github.com/lucasitoo.png"
                alt="Lucas"
